<x-like-btns :tweet="$tweet"></x-like-btns>
                                    ...
                                    <div class="w-1/4 text-center ">
                                        <a href="/tweet/{{$tweet->id}}"  data-id="{{ $tweet->id }}"
                                            class="cursor-pointer comment open-comment">
                                    ...
                                    <div class="w-1/4 text-center relative ">
                                        ...
                                        <div class="hidden absolute z-10 h-8 w-8 bg-white shadow modal2"
                                            ...
                                            <ul class="text-sm text-gray-800 p-2">
                                                ...
                                                <li data-id="{{ $tweet->id }}"
                                                    class="border-b mb-1 pb-1 cursor-pointer unretweet">
                                                    Unretweet
                                                </li>
                                                @else
                                                <li data-id="{{ $tweet->id }}"
                                                    class="border-b mb-1 pb-1 cursor-pointer retweet">
                                                    Retweet
                                                </li>
                                                @endif
                                                <li data-id="{{ $tweet->id }}"
                                                    class="cursor-pointer retweet-comment open-popup">
                                                    Retweet with comment
                                                </li>
                                            </ul>
                                        </div>
                                        {{-- show number of retweets per tweet --}}
                                        <div class="items-center absolute text-sm text-gray-500"
