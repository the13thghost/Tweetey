<x-top-bar>
    <div class="font-bold text-xl ml-3 py-2">
        Home
    </div>
</x-top-bar>
    ...
    <form id="publish" action="/tweets" method="post" enctype="multipart/form-data" class="w-full">
        ...
        <div class="relative">
            <div class="textarea-1">
                <textarea class="textarea-fresh w-full block mb-3 p-2 text-xl outline-none"
                    style="min-height:120px;resize:none;" onblur="textCounter(this,this.form.counter,255);"
                    onkeyup="textCounter(this,this.form.counter,255);" name="body" id="body"
                    placeholder="What's going on?">{{ old('body') }}</textarea>
            </div>
            <div id="country_list"></div>
            <div class="counter-1">
                <input class="counter-fresh absolute text-blue-300" style="right:-18px;bottom:6px;background:none"
