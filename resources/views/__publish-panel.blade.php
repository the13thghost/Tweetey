...
<div class="border-l border-r border-b border-gray-300 px-3 py-4 flex">
    ...
    <form id="publish" action="/tweets" method="post" enctype="multipart/form-data" class="w-full">
        ...
        <div class="relative">
            ...
            <textarea id="sabina-tribute" class="textarea-fresh w-full block mb-3 p-2 text-xl" style="min-height:140px;resize:none"
                onblur="textCounter(this,this.form.counter,255);" onkeyup="textCounter(this,this.form.counter,255);"
                name="body" id="body" required placeholder="What's happening?">{{ old('body') }}</textarea>
            </div>
